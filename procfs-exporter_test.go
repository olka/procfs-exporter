...
func TestStat(t *testing.T) {
	expectedResult := "0, 2.93%, 0.81%, 96.03%, 0.16%, 0.00%, 0.07%, 0, 2.98%, 0.86%, 96.01%, 0.16%, 0.00%, 0.00%, 0, 2.89%, 0.76%, 96.05%, 0.17%, 0.00%, 0.13%, 8109530, 3416, 0, 4409058, 5, 478252, 2038, 1736808, 13786, 0, 476620, 432032, 0, 1269517"
